...
**Status: ⬜ OPEN — 6 of 25 built** (GAM-019 ✅ `4bb438165`; GAM-006 🟢 `062dfd9c0`; GAM-005 🟢 session 7, GAM-007 🟢 session 8, GAM-009 🟢 session 9 and GAM-008 🟢 session 10, all four uncommitted). GAM-025 is R8's "data wins later", registered in session 8. 7 rulings landed in session 1 (§4). GAM-012's
...
| [GAM-025](GAM-025-A-ROW-FIELD-NAMED-ON-READS-AS-THE-DATA.md) | A row field named `on` reads as the data | D64 | R8's second half, after GAM-007; call-site sweep first |
...
| [GAM-021](GAM-021-A-PLAN-IS-NOT-WARNED-ABOUT-THE-SCROLL-SETTING-IT-IS-ABOUT-TO-APPLY.md) | A plan is not warned about the scroll setting it is about to apply | D56 | — |
| [GAM-022](GAM-022-A-WRAPPED-ROW-OF-PILLS-IS-NOT-TOLD-TO-BECOME-COLUMNS.md) | A wrapped row of pills is not told to become columns | D50 | — |
